...
public final class Intersector {
	...
	public static boolean intersectRectangles (Rectangle a, Rectangle b) {
		return !(a.getX() > b.getX() + b.width || a.getX() + a.width < b.getX() || a.getY() > b.getY() + b.height || a.getY() + a.height < b.getY());
	}
	
	public static boolean pointInRectangle (Rectangle r, Vector3 p) {
		return r.getX() <= p.x && r.getX() + r.width >= p.x && r.getY() <= p.y && r.getY() + r.height >= p.y;
	}
	...
	public static boolean pointInRectangle (Rectangle r, float x, float y) {
		return r.getX() <= x && r.getX() + r.width >= x && r.getY() <= y && r.getY() + r.height >= y;
	}
	...
	public static boolean overlapCircles (Circle c1, Circle c2) {
		float x = c1.getX() - c2.getX();
		float y = c1.getY() - c2.getY();
	...
	public static boolean overlapRectangles (Rectangle r1, Rectangle r2) {
		if (r1.getX() < r2.getX() + r2.width && r1.getX() + r1.width > r2.getX() && r1.getY() < r2.getY() + r2.height && r1.getY() + r1.height > r2.getY())
			return true;
		else
			return false;
	}
	...
	public static boolean overlapCircleRectangle (Circle c, Rectangle r) {
		float closestX = c.getX();
		float closestY = c.getY();

		if (c.getX() < r.getX()) {
			closestX = r.getX();
		} else if (c.getX() > r.getX() + r.width) {
			closestX = r.getX() + r.width;
		}

		if ( c.getY() < r.getY() ) {
			closestY = r.getY();
		} else if (c.getY() > r.getY() + r.height) {
			closestY = r.getY() + r.height;
		}

		closestX = closestX - c.getX();
		closestX *= closestX;
		closestY = closestY - c.getY();
		closestY *= closestY;

		return closestX + closestY < c.getRadius() * c.getRadius();
	}
}
